#SIMPLE CLIMATE MODEL - ENERGY BUDGET 
...
#PART 2 - SURFACE FEATURES AND CLOUDS
#Area is given in percentage. 
...
surface_energy_reflected = (ocean_energy_reflected + vegetation_energy_reflected + desert_energy_reflected + ice_energy_reflected + cloud_energy_reflected)

#Solar Energy Absorbed 
total_energy_absorbed = (incoming_solar_energy - surface_energy_reflected)
